...
$tipo_evento = 1; //1=carreras , 2=duatlon , 3=ciclismo , 4=otro
$mesFiltro=$_GET["mes"];
//reverse
...
function available(date) {
  ...
  $(document).ready(function(){     
    ...
    <div class="titulo-micrositio">
        <div class="tit-competencia">CARRERAS</div>
    ...
    <?php   if(!empty($result)){?>
		...
		$microSitio=$result->microSitio;
		$UrlMicroSitio=$result->urlMicroSitio;
        $permalink = home_url() . "/detalle-evento/?id=$id_evento";

        //comprueb si existe micrositio
		
		if($microSitio==1){ ?>
		<div class="interior-competencia1">
            <a href="<?php echo $UrlMicroSitio; ?>">
