...
$tipo_evento = 2; //1=carreras , 2=duatlon , 3=ciclismo , 4=otro
$mesFiltro=$_GET["mes"];
//reverse
...
function available(date) {
  ...
  $(document).ready(function(){     
    ...
    <div class="titulo-micrositio">
        <div class="tit-competencia">TRIATLÓN / DUATLÓN</div>
        
        <div class="content-filtro">    
            <fieldset id="fieldset-filtro">
            <legend>Ver Calendario de Eventos</legend>  
                <input type="text" name=x    "datepicker"  id="datepicker" class="filtro-mes" readonly="readonly" value="<?php echo $mesFiltro; ?>"/>
